<div class="defaultForm form-horizontal moduledemo">
    ...
    <div class="panel" id="fieldset_0">
        ...
        <div class="row col">
            ...
            <div class="col-sm-9">
                {include file='module:moduledemo/views/templates/admin/configuration/configuration_welcome.tpl'}
                {include file='module:moduledemo/views/templates/admin/configuration/configuration_advanced_settings.tpl'}
                {include file='module:moduledemo/views/templates/admin/configuration/configuration_help.tpl'}
            </div>
        </div>
    </div>
</div>
